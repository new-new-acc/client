        ...
        <div className={classes.wrapper}>
          ...
          <div className={classes.descAndLikesViews}>
            ...
            <div className={classes.likesAndViews}>
              <span>{blogDetails?.views} просмотры</span>
              <span>{blogDetails?.likes?.length} лайки</span>
            </div>
          </div>
          <div className={classes.authorAndCreatedAt}>
            <span><span>Автор:</span> {blogDetails?.userId?.username}</span>
            <span><span>Создан:</span> {format(blogDetails?.createdAt)}</span>
          </div>
        </div>
      </div>
      <Footer />
