      ...
      <div className={classes.wrapper}>
        ...
        <div className={classes.categoriesAndBlogs}>
          ...
          {filteredBlogs?.length > 0 ?
                  ...
                  <div className={classes.blogData}>
                    <div className={classes.categoryAndMetadata}>
                      ...
                      <div className={classes.metadata}>
                        <MdOutlinePreview /> {blog.views} просмотры
                      </div>
                      <div className={classes.metadata}>
                        <AiFillLike /> {blog?.likes?.length} лайки
                      </div>
                    </div>
                    <h4>{blog?.title}</h4>
                    ...
                    <div className={classes.authorAndCreatedAt}>
                      <span><span>Автор:</span> {blog?.userId?.username}</span>
                      <span><span>Создан:</span> {format(blog?.createdAt)}</span>
                    </div>
            ...
            : <h3 className={classes.noBlogsMessage}>Блогов нет</h3>}
        </div>
      </div>
    </div>
  )
